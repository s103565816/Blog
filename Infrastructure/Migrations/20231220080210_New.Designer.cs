            ...
            modelBuilder.Entity("Domain.Entities.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PostId = 1,
                            CategoryId = 1,
                            DatePublished = new DateTime(2023, 12, 20, 15, 2, 10, 385, DateTimeKind.Local).AddTicks(7169),
                        ...
                        new
                        {
                            PostId = 2,
                            CategoryId = 2,
                            DatePublished = new DateTime(2023, 12, 20, 15, 2, 10, 385, DateTimeKind.Local).AddTicks(7180),
                            Modified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PostContent = "A very interesting post",
                            Published = true,
                            RateCount = 0,
                        ...
                        new
                        {
                            PostId = 3,
                            CategoryId = 3,
                            DatePublished = new DateTime(2023, 12, 20, 15, 2, 10, 385, DateTimeKind.Local).AddTicks(7181),
                            Modified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PostContent = "A very interesting post",
                            Published = true,
                            RateCount = 0,
